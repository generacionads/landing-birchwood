      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-6xl mx-auto bg-slate-50 rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
          <div className="flex flex-col md:flex-row">
            ...
            {/* Before Image */}
            <div className="relative w-full md:w-1/2 h-80 md:h-[500px] group overflow-hidden bg-slate-100 flex items-center justify-center">
              <img
            ...
            {/* After Image */}
            <div className="relative w-full md:w-1/2 h-80 md:h-[500px] group overflow-hidden border-t md:border-t-0 md:border-l border-white/20 bg-slate-100 flex items-center justify-center">
              <img
